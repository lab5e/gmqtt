...
type Publisher interface {
	...
	Publish(message *entities.Message)
}
...
type ClientService interface {
	...
	GetSession(clientID string) (*entities.Session, error)
...
type SubscriptionService interface {
	...
	Subscribe(clientID string, subscriptions ...*entities.Subscription) (rs subscription.SubscribeResult, err error)
