...
func (m *MockStore) GetRetainedMessage(topicName string) *entities.Message {
	m.ctrl.T.Helper()
...
func (m *MockStore) AddOrReplace(message *entities.Message) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMatchedMessages(topicFilter string) []*entities.Message {
	m.ctrl.T.Helper()
